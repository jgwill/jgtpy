...
def __cleanse_ao_peak_v1_secondary_columns(dfsrc, quiet=False):
...
def _pds_cleanse_original_columns(dfsrc, quiet=True):
...
def pds_cleanse_extra_columns(dfsrc, quiet=True):
    dfsrc = _pds_cleanse_original_columns(dfsrc, quiet)
    ...
    dfsrc = __cleanse_ao_peak_v1_secondary_columns(dfsrc, quiet)
    if not quiet:
