...
M1c, M1a,M1adf = ads.plot(instrument, "M1", show=show,cc=cc)

w1, w1a,w1df = ads.plot(instrument, "W1", show=show,cc=cc)
d1, d1a,d1df = ads.plot(instrument, "D1", show=show,cc=cc)

h4, h4a,h4df = ads.plot(instrument, "H4", show=show,cc=cc)
h1, h1a,h1df = ads.plot(instrument, "H1", show=show,cc=cc)
m15, m15a,m15df = ads.plot(instrument, "m15", show=show,cc=cc)
m5, m15a,m5df = ads.plot(instrument, "m5", show=show,cc=cc)
