...
M1c, M1a,_ = ads.plot(instrument, "M1", show=show,cc=cc)

w1, w1a,_ = ads.plot(instrument, "W1", show=show,cc=cc)
d1, d1a,_ = ads.plot(instrument, "D1", show=show,cc=cc)

h4, h4a,_ = ads.plot(instrument, "H4", show=show,cc=cc)
h1, h1a,_ = ads.plot(instrument, "H1", show=show,cc=cc)
m15, m15a,_ = ads.plot(instrument, "m15", show=show,cc=cc)
m5, m15a,_ = ads.plot(instrument, "m5", show=show,cc=cc)
